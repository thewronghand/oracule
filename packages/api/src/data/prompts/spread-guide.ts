...
export const spreadGuides: Record<SpreadType, string> = {
  ...
  TRIPLE_CHOICE:
    'The Triple Choice(트리플 - 양자택일) spread helps with decision-making by showing the current situation in the center card, with the left and right cards representing two different possible paths or choices.',
  FIVE_CARD_CROSS:
    'The Five Card Cross spread places cards in a cross pattern, with the center showing the current situation, surrounded by cards representing influences above, below, behind, and ahead.',
  CELTIC_CROSS:
    'The Celtic Cross is a comprehensive ten-card spread that explores multiple aspects of a situation, including past influences, future possibilities, hopes, fears, and potential outcomes.',
}
