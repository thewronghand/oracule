...
export const tarotDeck: TarotCard[] = [
  ...
  },
  {
    ...
    imageDescription: {
      scene:
        '빨간 로브를 입은 마법사가 제단 앞에 서서 한 손은 하늘을, 다른 손은 땅을 가리키고 있습니다.',
      elements: [
        '머리 위의 무한대(∞) 기호',
        '제단 위의 검, 지팡이, 성배, 펜타클',
  ...
  },
  {
    ...
    imageDescription: {
      scene:
        '에덴동산에서 나체의 남녀가 서로를 마주보고 있고, 그 위로 천사가 날개를 펼치고 있습니다.',
      elements: [
        '태양이 비치는 에덴동산',
        '여자 뒤의 지식의 나무와 뱀',
        '남자 뒤의 불타는 12개의 나무',
  ...
  },
  {
    ...
    imageDescription: {
      scene:
        '검은 망토를 입은 인물이 쓰러진 세 개의 성배를 바라보고 있고, 뒤에는 두 개의 성배가 서있습니다.',
      elements: [
        '검은 망토를 입은 슬픈 인물',
        '쏟아진 세 개의 성배',
        '서있는 두 개의 성배',
  ...
  },
  {
    ...
    imageDescription: {
      ...
      elements: ['산 위에 선 상인', '세 개의 완드', '항해하는 배들', '넓은 바다', '일출의 하늘'],
      symbolism: [
        '높은 위치: 넓은 시야와 전망',
        '배: 도착하는 기회',
        '세 완드: 확장과 성장',
  ...
  },
  {
    ...
    imageDescription: {
      ...
      elements: ['월계관 쓴 기사', '하얀 말', '축하하는 군중', '들어올린 완드들', '화려한 장식'],
      symbolism: [
        '월계관: 승리와 영예',
        '하얀 말: 순수한 성공',
        '축하하는 군중: 인정과 찬사',
  ...
  },
  {
    ...
    imageDescription: {
      ...
      elements: ['왕좌에 앉은 여왕', '손에 든 완드', '해바라기', '검은 고양이', '사자 장식의 왕좌'],
      symbolism: [
        '해바라기: 생명력과 자신감',
        '검은 고양이: 독립성과 직관',
        '사자 장식: 힘과 권위',
  ...
  },
  {
    ...
    imageDescription: {
      ...
      elements: ['왕좌에 앉은 왕', '불타는 완드', '도마뱀 장식', '사자 문양의 망토', '화려한 왕관'],
      symbolism: [
        '불타는 완드: 창조적 힘',
        '도마뱀: 적응력과 재생',
        '사자 문양: 용기와 리더십',
