				...
				>
					<XStack alignItems="center" gap="$2">
						{loading === "kakao" ? (
							...
							<SolitoImage src="/auth/kakao-logo.svg" width={20} height={20} alt="Kakao" style={{ width: 20, height: 20 }} />
						)}
				...
				>
					<XStack alignItems="center" gap="$2">
						{loading === "google" ? (
							...
							<SolitoImage src="/auth/google-logo.svg" width={20} height={20} alt="Google" style={{ width: 20, height: 20 }} />
						)}
